...
layout.forEach(element => {
    ...
    newDiv.style.paddingLeft = element.paddingLeft;
    newDiv.style.paddingRight = element.paddingRight;
    newDiv.style.paddingTop = element.paddingTop;
    newDiv.style.paddingBottom = element.paddingBottom;
